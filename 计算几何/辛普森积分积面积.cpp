...
double simpson(double a,double b,double fl,double fr,double fm){return (b-a)/6*(fl+4*fm+fr);}
...
double calc(double l,double r,double EPS){return integral(l,r,f(l),f(r),f((l+r)*0.5),EPS);}
